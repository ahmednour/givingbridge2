...
class LanguageService {
  ...
  static Future<Locale> getPreferredLocale() async {
    try {
      ...
      if (systemLocales.isNotEmpty) {
        ...
        if (LocaleProvider.supportedLocales.any((locale) => 
  ...
  static Future<void> importLanguageSettings(Map<String, dynamic> settings) async {
    try {
      final prefs = await SharedPreferences.getInstance();
      ...
      if (settings['language_setup_complete'] != null) {
        await prefs.setBool(_languageSetupCompleteKey, settings['language_setup_complete']);
      }
