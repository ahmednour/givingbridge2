...
void main() {
  group('LocaleProvider Tests', () {
    ...
    group('Directional Padding Methods', () {
      ...
      test('should handle horizontal and vertical parameters for padding', () async {
        await localeProvider.setLocale(const Locale('ar'));
        ...
        expect(padding, const EdgeInsets.symmetric(horizontal: 15.0, vertical: 25.0));
      });
    });
    ...
    group('Directional Axis Alignment Methods', () {
      ...
      test('should return correct cross axis alignment for LTR', () async {
        ...
        expect(alignment, CrossAxisAlignment.start); // Should use 'start' for LTR
      });
      ...
      test('should return correct main axis alignment for LTR', () async {
        ...
        expect(alignment, MainAxisAlignment.start); // Should use 'start' for LTR
      });
    });
    ...
    group('Directional Border Radius Methods', () {
      test('should return correct directional border radius for RTL', () async {
        ...
        expect(borderRadius.topRight.x, 5.0); // topStart goes to topRight in RTL
        expect(borderRadius.bottomLeft.x, 20.0); // bottomEnd goes to bottomLeft in RTL
        expect(borderRadius.bottomRight.x, 15.0); // bottomStart goes to bottomRight in RTL
      });
      ...
      test('should return correct directional border radius for LTR', () async {
        ...
        expect(borderRadius.bottomLeft.x, 15.0); // bottomStart goes to bottomLeft in LTR
        expect(borderRadius.bottomRight.x, 20.0); // bottomEnd goes to bottomRight in LTR
      });

      test('should handle all parameter for border radius', () async {
        await localeProvider.setLocale(const Locale('ar'));
        
        final borderRadius = localeProvider.getDirectionalBorderRadius(all: 8.0);
    ...
    group('Directional Icon Methods', () {
      ...
      test('should fallback to default icons when no parameters provided', () async {
        await localeProvider.setLocale(const Locale('ar'));
    ...
    group('Locale Persistence', () {
      ...
      test('should handle SharedPreferences errors gracefully', () async {
        ...
        expect(() => localeProvider.setLocale(const Locale('en')), returnsNormally);
        expect(localeProvider.locale.languageCode, 'en');
      });
    });
  });
